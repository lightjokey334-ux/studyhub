...
var QUESTIONS_D2_POST = [
  ...
  },
  {
    ...
    image: null,
    options: ["Use the UPDATE command to make changes to the table", "Make the changes, then run the CREATE command again", "Create a new table to replace the old one", "Use the ALTER command to make changes to the table"],
    correct: [3]
  },
  {
    id: "d2_post_03",
    ...
    image: null,
    options: ["The name of the table", "The rows to add to the table", "The data types for each row within the table", "The columns to add to the table", "The data types for each column within the table"],
    correct: [0, 3, 4]
  },
  {
    id: "d2_post_04",
    ...
    image: null,
    options: ["Helps speed up queries within a table as long as the indexes are created with strategic purpose", "Ensures that fewer people are needed to manage a database", "Creates new tables automatically", "Stores SQL code within a database so it can be quickly accessed when creating new tables"],
    correct: [0]
  },
  {
    id: "d2_post_05",
    ...
    image: null,
    options: ["Create a new table with the CREATE command", "Create a new column with the CREATE command", "Alter the column with the ALTER command", "Restore the column to its default settings with the DEFAULT command"],
    correct: [2]
  },
  {
    id: "d2_post_06",
  ...
  },
  {
    ...
    image: "sql_code.png",
    options: ["The entire code will run", "The code will not run due to an error in the syntax", "The first SELECT statement will not run", "The second SELECT statement will not run"],
    correct: [3]
  },
  {
    id: "d2_post_08",
    ...
    image: null,
    options: ["The NON-CLUSTERED keyword", "The table on which the index is being created", "The columns being indexed", "The number of total columns"],
    correct: [2]
  },
  {
    id: "d2_post_09",
  ...
  },
  {
    ...
    image: null,
    options: ["A stored procedure hides SQL keywords from being exposed in app code", "A stored procedure accepts parameters", "A stored procedure allows for filtering of data", "A stored procedure has permissions"],
    correct: [0]
  }
];
